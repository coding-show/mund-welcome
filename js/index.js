...
var Electron = function () {
    function Electron () {
        ...
        var _ref6 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            ...
            lifeTime = _ref6$lifeTime === undefined ? 3 * 1e3 : _ref6$lifeTime,
            _ref6$speed = _ref6.speed,
            speed = _ref6$speed === undefined ? STEP_LENGTH : _ref6$speed,
            _ref6$color = _ref6.color,
            color = _ref6$color === undefined ? ELECTRON_COLOR : _ref6$color;
    ...
    _createClass(Electron, [{
        ...
        value: function randomPath () {
            ...
            var _MOVE_TRAILS$_$random = _slicedToArray(MOVE_TRAILS[_.random(length - 1)], 2),
                deltaX = _MOVE_TRAILS$_$random[0],
                deltaY = _MOVE_TRAILS$_$random[1];
...
var Cell = function () {
    function Cell () {
        ...
        var _ref7 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            ...
            electronCount = _ref7$electronCount === undefined ? _.random(1, 4) : _ref7$electronCount,
            _ref7$background = _ref7.background,
            background = _ref7$background === undefined ? ELECTRON_COLOR : _ref7$background,
            _ref7$forceElectrons = _ref7.forceElectrons,
            forceElectrons = _ref7$forceElectrons === undefined ? false : _ref7$forceElectrons,
            _ref7$electronOptions = _ref7.electronOptions,
            electronOptions = _ref7$electronOptions === undefined ? {} : _ref7$electronOptions;
        ...
        value: function createElectrons () {
            ...
            for (var i = 0; i < max; i++) {
                var _popRandom = this.popRandom(endpoints),
                    _popRandom2 = _slicedToArray(_popRandom, 2),
                    offsetX = _popRandom2[0],
                    offsetY = _popRandom2[1];
...
var shape = {
    ...
    getTextMatrix: function getTextMatrix (text) {
        var _ref14 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
            ...
            fontWeight = _ref14$fontWeight === undefined ? 'bold' : _ref14$fontWeight,
            _ref14$fontFamily = _ref14.fontFamily,
            fontFamily = _ref14$fontFamily === undefined ? FONT_FAMILY : _ref14$fontFamily;
    ...
    spiral: function spiral () {
        var _ref17 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            ...
            reverse = _ref17$reverse === undefined ? false : _ref17$reverse,
            _ref17$lifeTime = _ref17.lifeTime,
            lifeTime = _ref17$lifeTime === undefined ? 250 : _ref17$lifeTime,
            _ref17$electronCount = _ref17.electronCount,
            electronCount = _ref17$electronCount === undefined ? 1 : _ref17$electronCount,
            _ref17$forceElectrons = _ref17.forceElectrons,
            forceElectrons = _ref17$forceElectrons === undefined ? true : _ref17$forceElectrons;
...
document.getElementById('input').addEventListener('keypress', function (_ref18) {
